    ...
    return (
        <div>
            <ProjectItem
                ...
                projectDescription={
                    "- Một dự án đầu tiên! Một ý tưởng nhất thời của cả nhóm \
                ...
                projectResult={
                    ...
                    Sau dự án bản thân đã học được thêm những công nghệ mới và biết cách xây dựng một Restful API, được làm việc với Hangfire cũng như một chút về front-end developer. \
            ...
            <ProjectItem
                ...
                projectPosition="Backend Developer/Leader"
                projectDescription={
                    "- Website nghe nhạc trực tuyến cùng với nhau và nhạc của tất cả những người trong phòng được đồng bộ thời gian với nhau sử dụng công nghệ Socket và framework Socket.io. Sản phẩm sử dụng ngôn ngữ lập trình chính là: JavaScript. Cùng với có là một số những Framework khác như Express xây dựng Restful API và Sequelize(ORM) hỗ trợ cho việc tương tác với database PosgreSQL, về phần của admin gồm có những chứng năng như được quyền thêm xóa sửa bài hát. Người dùng đăng nhập vào Website để được nghe nhạc online cùng với chủ phòng kèm với đó là các tính năng như bình luận."
                }
                projectMember="5"
                projectContribute={
                    "- Tìm hiểu và triển khai dự án, lên lộ trình và từng bước để hoàn thành dự án sử dụng những công cụ quản lý như Linear.app và GitLab. Backend chính của dự án đóng góp 80% backend và xây dựng 90% admin page bằng ReactTS cũng như triển khai từng bước kết nối Server và Client. "
                }
                projectResult={
                    "- Hài lòng với kết quả cuối cùng mà cả nhóm tạo ra được. Thời gian thực hiện 3 tháng với một khối lượng công việc lớn nhưng vì đã trãi qua 1-2 dự án trước đó nên việc setup tìm hiểu cũng trở nên nhanh chóng và dễ dàng hơn!"
                }
            ...
            <ProjectItem
                ...
                projectDescription={
                    "- Website thương mại điện tử cho phép người dùng đăng nhập mua và đặt hàng sản phẩm của như khởi tạo cửa hàng và bắt đầu bán hàng. Sử dụng PHP Laravel và PostgreSQL. "
                }
                projectMember="4"
                projectPosition="Backend Developer/Leader"
                projectContribute="- Lên kế hoạch thực hiện cho cả nhóm, thiết kế database và xây dựng 100% backend với ngôn ngữ chính là PHP và Laravel với mô hình Restful API."
                projectResult={
                    "- Kết quả đáp ứng đủ những yêu cầu đặt ra lúc ban đầu 8/10. Thời gian bắt đầu và hoàn thành trong 2 tháng nên cũng có nhiều hạn chế như chưa áp dụng được GraphQL và Tối ưu hệ thống chưa thật sự tốt!"
                }
